                ...
                <div id="center">
                    ...
                    <div className='unit'>
                        <svg className="circuit-lines" width="100%" height="100%">
                            <line x1="350px" y1="150px" x2="250px" y2="150px" className="line" />
                            <line x1="250px" y1="150px" x2="250px" y2="80px" className="line" />
                    ...
                    <div className='unit'>
                        <svg className="circuit-lines" width="100%" height="100%">
                            <line x1="650px" y1="150px" x2="750px" y2="150px" className="line" />
                            <line x1="750px" y1="150px" x2="750px" y2="80px" className="line" />
                    ...
                    <div className='unit'>
                        <svg className="circuit-lines" width="100%" height="100%">
                            <line x1="650px" y1="350px" x2="750px" y2="350px" className="line" />
                            <line x1="750px" y1="350px" x2="750px" y2="420px" className="line" />
